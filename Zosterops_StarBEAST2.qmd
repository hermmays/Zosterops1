...
We are using BEAST v2.7.4 for the analysis [@bouckaert2019; @bouckaert2014; @drummond2012; @drummond2007]. Quarto version 1.6.39 was used to document the workflow.
...
- `Zosterops taxon sets mtDNA.txt`
